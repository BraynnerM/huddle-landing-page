...
Esta é uma solução para o desafio do Frontend Mentor [Huddle landing page with single introductory section challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/huddle-landing-page-with-a-single-introductory-section-B_2Wvxgi0). Os desafios do Frontend Mentor ajudam a melhorar minhas habilidades de codificação criando projetos realistas.
...
- URL da solução: [Github](https://github.com/BraynnerM/huddle-landing-page)
-  URL do site no Github Pages: [Huddle Landing Page](https://braynnerm.github.io/huddle-landing-page/)
